...
/**
* \defgroup CUDA_MATHcuhalf_ARITHMETIC Half Arithmetic Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf2_ARITHMETIC Half2 Arithmetic Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf_COMPARISON Half Comparison Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf2_COMPARISON Half2 Comparison Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf_MISC Half Precision Conversion And Data Movement
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf_FUNCTIONS Half Math Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/

/**
* \defgroup CUDA_MATHcuhalf2_FUNCTIONS Half2 Math Functions
* \ingroup CUDA_MATH_INTRINSIC_HALF
* To use these functions include the header file \p cuda_fp16.h in your program.
*/
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf __float2half(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
* \brief Converts float number to half precision in round-to-nearest-even mode
* and returns \p half with converted value.
...
* \retval \p a converted to half. 
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf __float2half_rn(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* \retval \p a converted to half. 
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf __float2half_rz(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* \retval \p a converted to half. 
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf __float2half_rd(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* \retval \p a converted to half. 
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf __float2half_ru(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ float cuhalf2float(const cuhalf a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* precision number.
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf2 __float2half2_rn(const float a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf2 __floats2half2_rn(const float a, const float b);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ float __low2float(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ float __high2float(const cuhalf2 a);
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ cuhalf2 __float22half2_rn(const float2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_HOSTDEVICE_FP16_DECL__ float2 cuhalf22float2(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
/**
* \ingroup CUDA_MATHcuhalf_FUNCTIONS
...
/**
* \ingroup CUDA_MATHcuhalf2_FUNCTIONS
...
*/
__CUDA_FP16_DECL__ cuhalf2 cuhalf2half2(const cuhalf a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __lowhigh2highlow(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __lows2half2(const cuhalf2 a, const cuhalf2 b);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __highs2half2(const cuhalf2 a, const cuhalf2 b);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf __high2half(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf __low2half(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_COMPARISON
...
*/
__CUDA_FP16_DECL__ cuhalf2 __halves2half2(const cuhalf a, const cuhalf b);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __low2half2(const cuhalf2 a);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __high2half2(const cuhalf2 a);
...
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl)) cuhalf2 __shfl(cuhalf2 var, int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_up)) cuhalf2 __shfl_up(cuhalf2 var, unsigned int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_down))cuhalf2 __shfl_down(cuhalf2 var, unsigned int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_xor)) cuhalf2 __shfl_xor(cuhalf2 var, int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl)) cuhalf __shfl(cuhalf var, int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_up)) cuhalf __shfl_up(cuhalf var, unsigned int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_down)) cuhalf __shfl_down(cuhalf var, unsigned int delta, int width = warpSize);
__CUDA_FP16_DECL__ __DEPRECATED__(__WSB_DEPRECATION_MESSAGE(__shfl_xor)) cuhalf __shfl_xor(cuhalf var, int delta, int width = warpSize);
...
*/
__CUDA_FP16_DECL__ cuhalf2 __shfl_sync(unsigned mask, cuhalf2 var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf2 __shfl_up_sync(unsigned mask, cuhalf2 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf2 __shfl_down_sync(unsigned mask, cuhalf2 var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf2 __shfl_xor_sync(unsigned mask, cuhalf2 var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
* \brief Exchange a variable between threads within a warp. Direct copy from indexed thread. 
* 
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf __shfl_sync(unsigned mask, cuhalf var, int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread with lower ID relative to the caller. 
* \details Calculates a source thread ID by subtracting delta from the caller's lane ID. 
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf __shfl_up_sync(unsigned mask, cuhalf var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread with higher ID relative to the caller. 
* 
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf __shfl_down_sync(unsigned mask, cuhalf var, unsigned int delta, int width = warpSize);
/**
* \ingroup CUDA_MATHcuhalf_MISC
* \brief Exchange a variable between threads within a warp. Copy from a thread based on bitwise XOR of own thread ID. 
* 
...
* If the source thread ID is out of range or the source thread has exited, the calling thread's own var is returned. 
*/
__CUDA_FP16_DECL__ cuhalf __shfl_xor_sync(unsigned mask, cuhalf var, int delta, int width = warpSize);
...
/**
* \ingroup CUDA_MATHcuhalf2_COMPARISON
...
/**
* \ingroup CUDA_MATHcuhalf2_ARITHMETIC
...
/**
* \ingroup CUDA_MATHcuhalf_ARITHMETIC
...
*/
__CUDA_FP16_DECL__ cuhalf2 __h2div(const cuhalf2 a, const cuhalf2 b);
/**
* \ingroup CUDA_MATHcuhalf2_ARITHMETIC
...
*/
__CUDA_FP16_DECL__  cuhalf __hdiv(const cuhalf a, const cuhalf b);
/**
* \ingroup CUDA_MATHcuhalf_ARITHMETIC
